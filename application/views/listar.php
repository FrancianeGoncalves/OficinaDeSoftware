				...
				<div class="col-lg-3 col-sm-6">
					<div class="card card-plain">
						...
						<div class="card-body px-0">
							...
							<p>
							<h6 class=" fa fa-users"></h6>	Rendimento: <?=$receita->receita->rendimento?> porções<br>
							<h6 class=" fa fa-clock"></h6>	Tempo (Minutos): <?=$receita->receita->tempo?><br>
							<h6 class=" fa fa-check"></h6>	<?php echo "Você possui ".$receita->receita->numero_ingredientes_select." de ".$receita->receita->numero_ingredientes." ingredientes presentes nessa receita";?><br>
							<?php if (intval($this->session->userdata('login')) == 1):
								 echo "<h6 class='fa fa-spoon'></h6> Você possui ".$receita->receita->numero_utensilios_select." de ".$receita->receita->numero_utensilios." utensílios presentes nessa receita<br>";
							 endif;?>
							</p>
