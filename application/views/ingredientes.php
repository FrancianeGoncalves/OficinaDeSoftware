			...
			<div class="container">
				...
				<div class="row">
					<div class="table-responsive">
						<button class="btn btn-warning bnt-addIngrediente" type="button" style="border-radius: 50%">
							<span class="btn-inner--icon"><i class="fa fa-plus"></i></span>
						</button>
						<table class="table align-items-center mb-0" id="tabela-ingredientes">
							<thead>
							<tr>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder">Nome</th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder">Ações</th>
							</tr>
							</thead>
							<tbody>
							<tr>
...
<script src="<?=base_url('assets/DataTables/datatables.min.js')?>" type="text/javascript"></script></body>
<script>
	...
	$('div.table-responsive').on('click', 'button#bnt-addIngrediente', function() {
