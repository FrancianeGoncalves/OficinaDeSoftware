					...
					<div class="table-responsive">
						<table class="table align-items-center mb-0 tableCenter" id="tabela-receitas">
							...
							<tr>
								...
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder"><h6>Rendimento</h6></th>
								<th class="text-uppercase text-secondary text-xxs font-weight-bolder"><h6>Tempo</h6></th>
							...
							<?php foreach ($receitas as $receita):?>
								<tr>
									...
									<td>
										<a href="<?=base_url('Receita/receita/'.$receita->uid)?>"
										  >
